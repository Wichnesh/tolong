...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('employerRenewal.insert') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" rows="5" id="address" name="address" readonly></textarea>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="lic" id="lic" readonly>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="per" id="per" readonly>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
           $(document).on('click' ,function(){
             ...
             console.log(empId);
             $.ajax({
                url:'get-empDetails/' + empId,
                method:"GET",
                // data:{empId:empId},
                success:function(response){
                    console.log(response)
                    $('#name').val(response.emp_name);
                    $('#address').val(response.emp_address);
                    $('#phone').val(response.emp_phone);
                    $('#ps_ise').val(response.passport_issue);
                    $('#ps_ex').val(response.passport_expire);
                    $('#lic').val(response.emp_lic);
                    $('#per').val(response.emp_per_code);
                },
